...
export default function AssessmentOverview({ assessments, onNew, onEdit, onPreview, onViewResults }) {
  return (
    <div>
      <div className="flex justify-between items-center mb-1">
        <h2 className="text-[24px] font-bold text-white">Assessment</h2>
      </div>
              ...
              {assessments.map((a, i) => {
                ...
                return (
                  <tr key={a.id} className="border-t border-border-apus">
                    ...
                    <td className="py-3 pr-3 text-[12.5px] font-medium">{a.name}</td>
