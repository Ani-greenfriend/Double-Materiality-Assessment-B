// Ported verbatim from reference-prototype/src/components/ApusLogo.jsx.
export default function ApusLogo({ height = 32 }) {
  return (
    <svg height={height} viewBox="0 0 240 70" xmlns="http://www.w3.org/2000/svg">
      <svg x="0" y="10" width="50" height="50" viewBox="0 0 350 320">
      ...
      <text x="66" y="44" fontFamily="Jost, sans-serif" fontWeight="500" fontSize="30" fill="#FFFFFF">apus</text>
    </svg>
  );
}
